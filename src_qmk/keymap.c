...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUML] = LAYOUT(
    //--------|--------|--------|--------|--------|-\    /-|--------|--------|--------|--------|--------|
       KC_PGDN,  KC_DEL,   KC_UP, KC_BSPC, KC_PGUP,/*    */  _______, _______, _______, _______, _______, 
    //--------|--------|--------|--------|--------|-|    |-|--------|--------|--------|--------|--------|
    ...
    //--------|--------|--------|--------|--------|-|    |-|--------|--------|--------|--------|--------|
       KC_BRMD, KC_VOLD, KC_MUTE, KC_VOLU, KC_BRMU,/*    */  _______, KC_LGUI, KC_LCTL, _______, KC_LALT, 
    //--------|--------|--------|--------|--------|-\    /-|--------|--------|--------|--------|--------|
    ...
    [_FR] = LAYOUT(
    //--------|--------|--------|--------|--------|-\    /-|--------|--------|--------|--------|--------|
       _______, _______, _______, _______,   RESET,/*    */   KC_F12,   KC_F7,   KC_F8,   KC_F9, _______, 
    //--------|--------|--------|--------|--------|-|    |-|--------|--------|--------|--------|--------|
       KC_LALT, _______, KC_LCTL, KC_LGUI, _______,/*    */   KC_F10,   KC_F4,   KC_F5,   KC_F6, _______, 
    //--------|--------|--------|--------|--------|-\    /-|--------|--------|--------|--------|--------|
