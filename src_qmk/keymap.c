...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //--------|--------|--------|--------|--------|-|    |-|--------|--------|--------|--------|--------|
                                  KC_LSFT,TO(_MINE),/*    */TO(_NUML),KC_LSFT
    ),
    ...
    //--------|--------|--------|--------|--------|-|    |-|--------|--------|--------|--------|--------|
                                  KC_LSFT,TO(_MINE),/*    */TO(_NUMR),KC_LSFT
    ),ööö

    [_FL] = LAYOUT(
    //--------|--------|--------|--------|--------|-\    /-|--------|--------|--------|--------|--------|
       KC_WH_U, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_D,/*    */  KC_ACL2, _______, _______, _______, _______, 
    //--------|--------|--------|--------|--------|-|    |-|--------|--------|--------|--------|--------|
       KC_WH_L, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_R,/*    */  KC_ACL1, KC_LGUI, KC_LCTL, _______, KC_LALT, 
    //--------|--------|--------|--------|--------|-\    /-|--------|--------|--------|--------|--------|
       KC_BRMD, KC_VOLD, KC_MUTE, KC_VOLU, KC_BRMU,/*    */  KC_ACL0, _______, _______, _______, _______, 
    //--------|--------|--------|--------|--------|-|    |-|--------|--------|--------|--------|--------|
                                  KC_LSFT,TO(_MINE),/*    */ TO(_FL), KC_LSFT
    ),
    ...
    //--------|--------|--------|--------|--------|-|    |-|--------|--------|--------|--------|--------|
                                  KC_LSFT,TO(_MINE),/*    */ TO(_FR), KC_LSFT
    ),
};
