...
KC_NO,  KC_ESC,  KC_TAB, _______,  KY_ENT, _______, _______, _______,/*    */  _______, _______, DE_MINS,    KC_1,    KC_2,    KC_3, DE_SLSH, KC_NO,
    ...
    [_F] = LAYOUT(
    //--------|--------|--------|--------|--------|-\                                        /-|--------|--------|--------|--------|--------|
KC_NO, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______,/*                                        */   KC_F12,   KC_F7,   KC_F8,   KC_F9, _______, KC_NO,
    //--------|--------|--------|--------|--------|-|                                        |-|--------|--------|--------|--------|--------|
KC_NO, _______, KC_VOLD, KC_MUTE, KC_VOLU, _______,/*                                        */   KC_F10,   KC_F4,   KC_F5,   KC_F6, _______, KC_NO,
    //--------|--------|--------|--------|--------|--------|--------|-\    /-|--------|--------|--------|--------|--------|--------|--------|
KC_NO, _______, _______, _______, _______, _______, _______, _______,/*    */  _______, _______,  KC_F11,   KC_F1,   KC_F2,   KC_F3, _______, KC_NO,
    //--------|--------|--------|--------|--------|--------|--------|-|    |-|--------|--------|--------|--------|--------|
                         _______, _______, _______, _______, _______,/*    */  _______, _______, _______, _______, _______
    ),
};