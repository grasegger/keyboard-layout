...
KC_NO, _______, _______,   KC_UP, _______, _______,/*                                        */  _______,    KC_7,    KC_8,    KC_9, _______, KC_NO,
    //--------|--------|--------|--------|--------|-|                                        |-|--------|--------|--------|--------|--------|
KC_NO, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______,/*                                        */     KC_0,    KC_4,    KC_5,    KC_6, _______, KC_NO,
    //--------|--------|--------|--------|--------|--------|--------|-\    /-|--------|--------|--------|--------|--------|--------|--------|
KC_NO, _______, _______, _______, _______, _______, _______, _______,/*    */  _______, _______, _______,    KC_1,    KC_2,    KC_3, _______, KC_NO,
    //--------|--------|--------|--------|--------|--------|--------|-|    |-|--------|--------|--------|--------|--------|
