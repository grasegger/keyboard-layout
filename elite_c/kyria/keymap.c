...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT(
       KC_PGDN, KC_DEL, KC_UP, KC_BSPC, KC_PGUP,/*                                        */  KC_PEQL,    KC_P7,    KC_P8,    KC_P9, KC_PSLS,
       KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END,/*                                        */  KC_PPLS,    KC_P4,    KC_P5,    KC_P6,    KC_P0,
       KC_ESC, KC_TAB, TO(_NUM),  KC_ENT, TO(_MINE), _______, _______,/*    */  _______, _______, KC_PMNS,    KC_P1,    KC_P2,    KC_P3, KC_PAST,
                         _______, _______,  DE_ADIA, DE_ODIA, _______,/*    */  _______, DE_UDIA, DE_SS, _______, _______,
    ),

    [_FUN] = LAYOUT(
       _______, _______, KC_BRMD, KC_BRMU, _______,/*                                        */  _______, KC_F7, KC_F8, KC_F9,KC_F12,
         KC_MPRV, KC_MNXT, KC_VOLD, KC_VOLU, _______,/*                                        */  _______, KC_F4, KC_F5, KC_F6, KC_F10,
       _______, _______, KC_MPLY, KC_MUTE, _______, _______, _______,/*    */  _______, _______,  _______, KC_F1, KC_F2, KF_C3, KC_F11,
